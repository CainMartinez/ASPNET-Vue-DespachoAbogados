        ...
        modelBuilder.Entity<Documento>(entity =>
        {
            ...
            entity.HasData(
                new Documento
                {
                    Id = 1,
                    ExpedienteId = 1,
                    NombreArchivo = "Demanda_Juicio_Verbal.pdf",
                    Descripcion = "Demanda de juicio verbal por reclamación de cantidad",
                    TipoDocumento = "Escrito Judicial",
                    RutaArchivo = "/documentos/expediente1/demanda_juicio_verbal.pdf",
                    TamanoBytes = 245760, // ~240 KB
                    Extension = ".pdf",
                    FechaCarga = new DateTime(2024, 5, 16),
                    CargadoPor = "Abg. Ana Pérez"
                },
                new Documento
                {
                    Id = 2,
                    ExpedienteId = 1,
                    NombreArchivo = "Facturas_Impagadas.pdf",
                    Descripcion = "Copia de las facturas objeto de reclamación",
                    TipoDocumento = "Prueba Documental",
                    RutaArchivo = "/documentos/expediente1/facturas_impagadas.pdf",
                    TamanoBytes = 512000, // ~500 KB
                    Extension = ".pdf",
                    FechaCarga = new DateTime(2024, 5, 5),
                    CargadoPor = "Cliente"
                },
                new Documento
                {
                    Id = 3,
                    ExpedienteId = 2,
                    NombreArchivo = "Papeleta_Conciliacion.pdf",
                    Descripcion = "Papeleta de conciliación previa a demanda laboral",
                    TipoDocumento = "Escrito Judicial",
                    RutaArchivo = "/documentos/expediente2/papeleta_conciliacion.pdf",
                    TamanoBytes = 180224, // ~176 KB
                    Extension = ".pdf",
                    FechaCarga = new DateTime(2024, 6, 18),
                    CargadoPor = "Abg. Carlos Méndez"
                },
                new Documento
                {
                    Id = 4,
                    ExpedienteId = 3,
                    NombreArchivo = "Informe_Pericial_Defectos_Construccion.pdf",
                    Descripcion = "Informe técnico del perito sobre defectos constructivos",
                    TipoDocumento = "Informe Pericial",
                    RutaArchivo = "/documentos/expediente3/informe_pericial.pdf",
                    TamanoBytes = 3145728, // ~3 MB
                    Extension = ".pdf",
                    FechaCarga = new DateTime(2024, 7, 25),
                    CargadoPor = "Perito Juan López"
                },
                new Documento
                {
                    Id = 5,
                    ExpedienteId = 4,
                    NombreArchivo = "Propuesta_Convenio_Regulador.docx",
                    Descripcion = "Propuesta de convenio regulador para divorcio",
                    TipoDocumento = "Documento Privado",
                    RutaArchivo = "/documentos/expediente4/propuesta_convenio.docx",
                    TamanoBytes = 98304, // ~96 KB
                    Extension = ".docx",
                    FechaCarga = new DateTime(2024, 9, 15),
                    CargadoPor = "Abg. Luis Martín"
                }
            );
        });
    }
